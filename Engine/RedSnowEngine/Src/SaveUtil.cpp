...
void SaveUtil::WriteQuaternion(const char* key, const Math::Quaternion& q, rapidjson::Document& doc,
...
void SaveUtil::WriteStringArray(const char* key, const std::vector<std::string>& strArray, rapidjson::Document& doc,
    rapidjson::Value& member)
{
    rapidjson::GenericStringRef<char> keyStr(key);
