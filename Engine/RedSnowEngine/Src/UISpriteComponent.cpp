...
{
    ASSERT(!mTextureFile.empty(), "UISpriteComponent: texture path is not set");
    mUISprite.Initialize(mTextureFile);
...
void UISpriteComponent::Serialize(rapidjson::Document& doc, rapidjson::Value& value,
